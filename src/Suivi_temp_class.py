...
for i in range(looprange) :
    ...
    plt.ylim([-1000, 0])
    plt.title('Cumuls - Nuits complètes, coloration par classe de cumul')
    plt.pause(0.001)
    ...
    plt.pause(0.001)
    plt.savefig('C:\\CumulusMX\\webfiles\\images\\class_cumuli_cumul.png')
    time.sleep(sleep2)
    plt.close()
    ...
    plt.axvline(pd.Timestamp('01/02/1900 00:00'), c='white', lw=1)
    plt.axvline(dt.datetime.strptime('01/01/1900 ' + (dt.datetime.today() + dt.timedelta(hours=-18, minutes=0, seconds=0)).strftime("%H:%M"), '%d/%m/%Y %H:%M') + dt.timedelta(hours=18, minutes=0, seconds=0), c='white', lw=1, ls = '--')
    plt.title('Températures - Nuits complètes, coloration par classe de cumul')
    plt.pause(0.001)
    ...
    plt.pause(0.001)
    plt.savefig('C:\\CumulusMX\\webfiles\\images\\class_cumuli_temp.png')
    time.sleep(sleep2)
    plt.close()
    ...
    plt.axvline(pd.Timestamp('01/02/1900 00:00'), c='white', lw=1)
    plt.axvline(dt.datetime.strptime('01/01/1900 ' + (dt.datetime.today() + dt.timedelta(hours=-18, minutes=0, seconds=0)).strftime("%H:%M"), '%d/%m/%Y %H:%M') + dt.timedelta(hours=18, minutes=0, seconds=0), c='white', lw=1, ls = '--')
    plt.title('Températures - Nuits complètes, coloration par classe de températures')
    plt.pause(0.001)
    ...
    plt.pause(0.001)
    plt.savefig('C:\\CumulusMX\\webfiles\\images\\class_tempi_temp.png')
    time.sleep(sleep2)
    plt.close()
    ...
    plt.axvline(dt.datetime.strptime('01/01/1900 ' + (dt.datetime.today() + dt.timedelta(hours=-18, minutes=0, seconds=0)).strftime("%H:%M"), '%d/%m/%Y %H:%M') + dt.timedelta(hours=18, minutes=0, seconds=0), c='white', lw=1, ls = '--')
    plt.ylim([-1000, 0])
    plt.title('Cumuls - Nuits complètes, coloration par classe de température')
    plt.pause(0.001)
    ...
    plt.pause(0.001)
    plt.savefig('C:\\CumulusMX\\webfiles\\images\\class_tempi_cumul.png')
    time.sleep(sleep2)
    plt.close()