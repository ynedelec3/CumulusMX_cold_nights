...
for i in range(nclasses) :
    axs.fill_between(mmc[rang_classe[i]]['t'].to_list(), mmc[rang_classe[i]]['cmin'].to_list(), mmc[rang_classe[i]]['cmax'].to_list(), linewidth = nclasses - i, color = sns.color_palette(palette, nclasses)[i], alpha=0.2)
...
for i in range(nclasses) :
    axs.fill_between(mmc[rang_classe[i]]['t'].to_list(), mmc[rang_classe[i]]['tmin'].to_list(), mmc[rang_classe[i]]['tmax'].to_list(), linewidth = nclasses - i, color = sns.color_palette(palette, nclasses)[i], alpha=0.2)
mng = plt.get_current_fig_manager()
mng.canvas.set_window_title('Courbe températures nocturnes')
mng.window.wm_iconbitmap("D:\\NedelecDev\\nbpython38\\suivi_temp.ico")
mng.window.state('iconic')
...
for i in range(looprange) :
    ...
    g = sns.lineplot(x = 'heure', y = 'cumul', data = nuits, hue = 'date', palette = chron_palette, estimator=None, ax = axs)
    for i in range(nclasses) :
        axs.fill_between(mmc[rang_classe[i]]['t'].to_list(), mmc[rang_classe[i]]['cmin'].to_list(), mmc[rang_classe[i]]['cmax'].to_list(), linewidth = i, color = sns.color_palette(palette, nclasses)[i], alpha=0.2)
    mng = plt.get_current_fig_manager()
    mng.canvas.set_window_title('Courbe températures nocturnes')
    mng.window.wm_iconbitmap("D:\\NedelecDev\\nbpython38\\suivi_temp.ico")
    mng.window.state('iconic')
    ...
    g = sns.lineplot(x = 'heure', y = 'temp', data = nuits, hue = 'date', palette = chron_palette, estimator=None, ax = axs)
    for i in range(nclasses) :
        axs.fill_between(mmc[rang_classe[i]]['t'].to_list(), mmc[rang_classe[i]]['tmin'].to_list(), mmc[rang_classe[i]]['tmax'].to_list(), linewidth = i, color = sns.color_palette(palette, nclasses)[i], alpha=0.2)
    mng = plt.get_current_fig_manager()
    mng.canvas.set_window_title('Courbe températures nocturnes')
    mng.window.wm_iconbitmap("D:\\NedelecDev\\nbpython38\\suivi_temp.ico")
    mng.window.state('iconic')
